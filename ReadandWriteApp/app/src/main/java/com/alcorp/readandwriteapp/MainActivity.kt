package com.alcorp.readandwriteapp
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showList() {
        ...
        /**
        * Path dengan tipe data file digunakan untuk menampung data yang
        digunakan sebagai penyimpanan write dan read
        *
        * Method getFilesDir() berfungsi untuk mendapatkan pengembalian
        file dari direktori yang ada di android.
        */
    ...
    private fun saveFile() {
        when {
            ...
            edit_file.text.toString().isEmpty() ->
                ...
                Toast.makeText(this, "Saveing " + fileModel.filename + " file", Toast.LENGTH_SHORT).show()
            }
        }
    }
}