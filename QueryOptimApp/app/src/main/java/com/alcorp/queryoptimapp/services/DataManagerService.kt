package com.alcorp.queryoptimapp.services
...
import com.alcorp.queryoptimapp.prefs.AppPreference
        ...
        if (firstRun){
            ...
            */
            ...
            try {
                ...
                //Jika service atau activity dalam keadaan destroy maka data insert tidak di eksekusi
                when {
                    job.isCancelled -> {
...
//            }
    ...
    private fun preLoadRaw(): ArrayList<MahasiswaModel> {
        ...
        try {
            val rawText = resources.openRawResource(com.alcorp.queryoptimapp.R.raw.data_mahasiswa)
